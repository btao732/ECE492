...
HD_PWD='C:/Users/Moose/Documents/School/ECE492/Platform/Platform.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PISO_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PISO_controller.tcl
