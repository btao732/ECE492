...
HD_PWD='C:/Users/Moose/Documents/School/ECE492/Platform/Platform.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PISO_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PISO_controller.tcl -notrace
