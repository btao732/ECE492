...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../Platform.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../Platform.gen/sources_1/bd/system/ipshared/5765/hdl" \
       +incdir+"../../../../Platform.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../Platform.gen/sources_1/bd/system/ipshared/5765/hdl" \
